...
Data = pd.read_csv('/Users/danielmaciel/Library/CloudStorage/OneDrive-inpe.br/Doutorado/Artigos/Global Secchi/Data/In_situ_secchi/Gathered/TM/acolite.csv')
Data = pd.read_csv('/Users/danielmaciel/Library/CloudStorage/OneDrive-inpe.br/Doutorado/Artigos/TemporalTrendsAmazon/Data/GLORIA_LAbisa Validation/Secchi_Landsat5_LARSC_FINAL_validation.csv')
...
validation = apply_secchi.loc[:, ('blue', 'green', 'red', 'green_blue', 'green_red')].to_numpy()



validation_reshape = np.reshape(validation, (1, len(validation), 5))
...
final_df.to_csv('MDN/ModelAplication/tm_results_labisa.csv')
