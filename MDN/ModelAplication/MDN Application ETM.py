...
Data = pd.read_csv('/Users/danielmaciel/Library/CloudStorage/OneDrive-inpe.br/Doutorado/Artigos/Global Secchi/Data/In_situ_secchi/Gathered/ETM/acolite_v2.csv')
#Data = pd.read_csv('/Users/danielmaciel/Downloads/sr_validation_.csv')
...
final_df.to_csv('MDN/ModelAplication/etm_results_v2_ratio.csv')
