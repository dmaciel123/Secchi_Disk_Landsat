...
dataset = pd.read_csv(r"MDN/DatasetFiltered/filtered_TM_v2.csv", sep = ',')
...
for i in range(2,50):
    ...
    args = get_args(no_load=True,sensor='TM',product='secchi', 
    ...
    a = f"MDN/MonteCarlo/TM_bandRatio/MDN_run_number_{i}.csv"
