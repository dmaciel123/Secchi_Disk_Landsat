...
dataset = pd.read_csv(r"MDN/DatasetFiltered/filtered_ETM_v2.csv", sep = ',')
...
for i in range(0,50):
    ...
    args = get_args(no_load=True,sensor='ETM',product='secchi', 
    ...
    a = f"MDN/MonteCarlo/ETM_bandRatio/MDN_run_number_{i}.csv"
