...
dataset = pd.read_csv(r"MDN/DatasetFiltered/dataset_tm_v3.csv", sep = ',')
...
for i in range(26,50):
    ...
    a = f"/Users/danielmaciel/Library/CloudStorage/OneDrive-inpe.br/Doutorado/Artigos/Global Secchi/MDN/MonteCarlo/TM/MDN_run_number_{i}.csv"
