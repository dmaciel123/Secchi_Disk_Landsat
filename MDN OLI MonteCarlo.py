...
dataset = pd.read_csv(r"MDN/DatasetFiltered/dataset_oli_v3.csv", sep = ',')
...
for i in range(0,50):
    ...
    a = f"/Users/danielmaciel/Library/CloudStorage/OneDrive-inpe.br/Doutorado/Artigos/Global Secchi/MDN/MonteCarlo/OLI/MDN_run_number_{i}.csv"
