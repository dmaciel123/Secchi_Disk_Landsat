...
dataset = pd.read_csv(r"MDN/DatasetFiltered/filtered_OLI_v3.csv", sep = ',')
...
for i in range(35,50):
    ...
    args = get_args(no_load=True,sensor='OLI-NoCoastal',product='secchi', 
    ...
    a = f"/Users/danielmaciel/Library/CloudStorage/OneDrive-inpe.br/Doutorado/Artigos/Global Secchi/MDN/MonteCarlo/v3/OLI/MDN_run_number_{i}.csv"
