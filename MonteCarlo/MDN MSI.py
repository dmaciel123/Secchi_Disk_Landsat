...
dataset = pd.read_csv(r"MDN/DatasetFiltered/filtered_MSI_v2.csv", sep = ',')
...
for i in range(1,50):
    ...
    X_train = train[["B2", "B3", "B4", 'B5', 'B6', 'B7']]
    X_test = test[["B2",  "B3", "B4",  'B5', 'B6', 'B7']]
    ...
    args = get_args(no_load=True,sensor='MSI-Secchi',product='secchi', 
                n_rounds = 10, benchmark=False, use_ratio = False,  n_mix = 5)
    ...
    a = f"MDN/MonteCarlo/NoBandRatio/MSI/MDN_run_number_{i}.csv"
