...
#ETM+
FILTROS = list.files('/Users/danielmaciel/Library/CloudStorage/OneDrive-inpe.br/Doutorado/Artigos/Global Secchi/Data/In_situ_secchi/Gathered/filters/Data/ETM') %>% strsplit(' ') %>% unlist() 
FILTROS = FILTROS[!str_detect(FILTROS, 'IMG')] %>% gsub(pattern = '_ETM.jpeg',replacement = '')
DATA = DATA[DATA$uid %in% FILTROS, ]
